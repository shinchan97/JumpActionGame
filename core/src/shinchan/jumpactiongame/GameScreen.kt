...
class GameScreen(private val mGame: JumpActionGame) : ScreenAdapter() {
    ...
    private var mPrefs: Preferences //added
    ...
    init {
        ...
        //GUI用のカメラを初期化する
        mGuiCamera = OrthographicCamera() // added
        mGuiCamera.setToOrtho(false, GUI_WIDTH, GUI_HEIGHT) // added
        mGuiViewPort = FitViewport(GUI_WIDTH, GUI_HEIGHT, mGuiCamera) //added
